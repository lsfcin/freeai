...
> Generated by `core/hooks/entropy/dashboard/entropy-dashboard.py`, which scans `code/freeai`. Never edit inside this block, and never copy a count out of it — a copied number is the drift these checks exist to catch.

2026-08-31 · 10 tracked files scanned · **8 findings here**
...
- ISSUES.md: cites 'Front 17' (line 75).
...
- code/freeai/CONTEXT.md — 2 line(s) over the 120-column cap (first at line 2)
- code/freeai/README.md — 7 line(s) over the 120-column cap (first at line 2)
- code/freeai/ROADMAP.md — 3 line(s) over the 120-column cap (first at line 12)
- code/freeai/harnesses.md — 2 line(s) over the 120-column cap (first at line 2)
- code/freeai/ide.md — 2 line(s) over the 120-column cap (first at line 2)
- code/freeai/modelos.md — 2 line(s) over the 120-column cap (first at line 2)
- code/freeai/provedores.md — 2 line(s) over the 120-column cap (first at line 2)
